                         ...
                         <table class="w-full text-sm text-left text-gray-700">
                              <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                   <tr className='my-table'>
                                        <th width={30} class="px-1 py-3 border text-center">
                                             #
                                        </th>
                                        <th width={80} class="px-3 pl-2 border">
                                             ລະຫັດສິນຄ້າ
                                        </th>
                                        <th width={350} class="px-3 pl-2 border">
                                             ຊື່ສິນຄ້າ
                                        </th>
                                        <th width={80} class="px-3 pl-2 border">
                                             ຈຳນວນ / ລັງ
                                        ...
                                        <th width={70} class="px-3 pl-2 border">
                                             ສ່ວນຫລຸດ
                                        </th>
                                        <th width={100} class="px-3 pl-2 border">
                                             ລວມ
                                        </th>
                                        <th width={60} class="px-3 pl-2">
                                             ຈັດການ
                                        </th>
                                   </tr>
                              </thead>
                                        ...
                                        index?.map((row, idx) => {
                                             return (
                                                  <tr key={idx} class="bg-white border-b ">
                                                       <td class="px-3 py-4 text-center text-gray-900">
                                                            {idx + 1}
                                                       </td>
                                                       ...
                                                       <td class="px-3 py-4">
                                                            <input
                                                                 ...
                                                                 min="0"
                                                                 value={setindex.qty_total}
                                                                 onChange={(e) => handleInputQty(e.target.value, row.id)}
                                                            />
                                                       </td>
                                                       <td class="px-3 py-4">
                                                            <input
                                                                 ...
                                                                 id="inline-full-name" type="number"
                                                                 min="0"
                                                                 value={setindex.price_income}
                                                                 onChange={(e) => handleInputPrice(e.target.value, row.id)}
                                                            />
                                                       </td>
                                                       <td class="px-3 py-4">
                                                            <input
                                                                 ...
                                                                 id="inline-full-name" type="number"
                                                                 min="0"
                                                                 value={setindex.discount}
                                                                 onChange={(e) => handleInputDis(e.target.value, row.id)}
                                                            />
                                                       </td>
